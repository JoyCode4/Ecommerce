...
const UserProfile: React.FC<Props> = ({ }) => {
  ...
  const handleEdit = (addressUpdate: any, index: number) => {
    const newUser = { ...user, addresses: [...user.addresses] }; // for shallow copy issue
    addressUpdate.id = user.addresses[index].id;
  ...
  const handleRemove = (e: any, index: number) => {
    ...
    dispatch(updateUserAsync(newUser));
    toast.success("User Address Deleted");
  };
    ...
    <div>
      ...
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl my-5 font-bold tracking-tight text-gray-900">
            Name: {(user && user?.name) ? user.name : (user && user.addresses && user.addresses.length>0 ? (user.addresses[0].firstName + " " + user.addresses[0].lastName) : 'New User')}
          </h1>
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <button
            ...
            type="submit"
            className="rounded-md my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Add New Address
          </button>
          {showAddAddressForm ? (
              ...
              (
                <div className="flex flex-col items-center justify-center h-[70vh] text-gray-600">
                  <div className="animate-pulse bg-gray-100 p-6 rounded-full mb-4">
                    <MapIcon className="w-14 h-14 text-gray-400" />
                  </div>
                  <h2 className="text-2xl font-semibold">No Address Added</h2>
                  <p className="text-sm text-gray-500 mt-2 text-center max-w-xs">
                    You haven't saved any addresses yet. Add an address to make ordering faster and easier.
                  </p>
                </div>
              ) :
              (
                          ...
                          <div className="space-y-12">
                            ...
                            <div className="mt-6 flex items-center justify-end gap-x-6">
                              <button
                                ...
                                type="submit"
                                className="rounded-md px-3 py-2 text-sm font-semibold text-grey shadow-sm hover:bg-grey-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                              >
                                Cancel
                              </button>
                              <button
