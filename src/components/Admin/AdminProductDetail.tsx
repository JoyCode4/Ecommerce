...
const AdminProductDetail: React.FC<Props> = ({ }) => {
  ...
  useEffect(()=>{
    dispatch(fetchProductByIdAsync(id as string));
  },[])

  const handleCart=(e:any)=>{
    e.preventDefault();
    dispatch(addToCartAsync({...product,user:user.id}));
  }
      ...
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            {product.breadcrumbs && product.breadcrumbs.length>0 && product.breadcrumbs.map((breadcrumb:any) => (
            ...
            <li className="text-sm">
              <Link href={product.thumbnail} aria-current="page" className="font-medium text-gray-500 hover:text-gray-600">
                {product.title}
              </Link>
            </li>
          </ol>
            ...
            <div className="mt-10">
              ...
              <div className="mt-4">
                <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                  {highlights && highlights.length>0 && highlights.map((highlight:any) => (
