...
// Sample product list (Replace with a database in production)
const products = [
    {
    "id": 1,
...
export const GET = withDbConnect(async () => {
...
//       return NextResponse.json({ message: "Item updated", product:products[productIndex] }, { status: 200 });
//   } catch (error) {
//       return NextResponse.json({ error: "Invalid request" }, { status: 400 });
//   }
// }
